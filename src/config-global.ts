...
export const CHECKOUT_SUCCESS_RETURN_URL =
  window.location.origin + import.meta.env.VITE_SUCCESS_URL;
export const CHECKOUT_FAILED_RETURN_URL = window.location.origin + import.meta.env.VITE_FAILED_URL;
// ----------------------------------------------------------------------
